...
namespace HSKR.Identity
{
    public class MyUserManager : UserManager<MyUser, long>
    {
        ...
        {
            UserValidator = new UserValidator<MyUser, long>(this)
            {
            ...
            //{
            //    UserTokenProvider = new DataProtectorTokenProvider<MyUser, long>(dataProtectionProvider.Create("ASP.NET Identity"));
            //}
        }
